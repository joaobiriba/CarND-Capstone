...
class TLClassifier(object):
    def __init__(self):
        # load classifier
        # self.MODEL_FILENAME = 'ssdlite_mobilenet_v2_coco_2018_05_09'
        self.MODEL_FILENAME = 'frozen_real_mobile'

        # Path to frozen detection graph.
        PATH_TO_CKPT = self.MODEL_FILENAME + '/frozen_inference_graph.pb'
    ...
    def get_classification(self, image):
        ...
        for idx, classID in enumerate(classes):
            if self.MODEL_FILENAME == 'ssdlite_mobilenet_v2_coco_2018_05_09':
                if classID == 10: # traffic light
                    if scores[idx] > 0.10:
    ...
    def get_color(self, image_rgb):
        ...
        red_slice, yellow_slice, green_slice = self.slice(std_l)
